...
const CreateInvoiceModal = ({ close }) => {
    ...
    // 🔥 Live Preview Calculation (UI Only)
    const preview = useMemo(() => {
        let sub = 0;
        let gst = 0;

        form.services.forEach((s) => {
            const taxable = Number(s.price || 0) * Number(s.quantity || 0);
            const gstAmount = (taxable * Number(s.gstRate || 0)) / 100;
            sub += taxable;
            gst += gstAmount;
        });
            ...
            <div className="bg-white w-[1000px] max-h-[95vh] overflow-y-auto p-8 rounded-xl shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        <h4 className="font-semibold mb-2">Invoice Preview</h4>
