...
const service = require("../services/brandStrategyIdentity.service");
const schema = require("../validations/brandStrategyIdentity.joi");

// CREATE / UPSERT
exports.createOrUpdate = asyncHandler(async (req, res, next) => {
  const { error } = schema.createBrandStrategySchema.validate(req.body);
  ...
  res.json({
    success: true,
    message: "Brand Strategy & Identity saved successfully",
    data: result,
  });
});
...
exports.deleteService = asyncHandler(async (req, res) => {
  ...
  res.json({
    success: true,
    message: "Brand Strategy & Identity deleted successfully",
  });
});
