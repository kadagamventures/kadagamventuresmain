...
const service = require("../services/videoProduction.service");
const schema = require("../validations/videoProduction.joi");

// CREATE / UPSERT
exports.createOrUpdate = asyncHandler(async (req, res, next) => {
  const { error } = schema.createVideoProductionSchema.validate(req.body);
  ...
  res.json({
    success: true,
    message: "Video Production service saved successfully",
    data: result,
  });
});
...
exports.deleteService = asyncHandler(async (req, res) => {
  ...
  res.json({
    success: true,
    message: "Video Production service deleted successfully",
  });
});
