...
const service = require("../services/softwareTestingQA.service");
const schema = require("../validations/softwareTestingQA.joi");

// CREATE / UPSERT
exports.createOrUpdate = asyncHandler(async (req, res, next) => {
  const { error } = schema.createSoftwareTestingSchema.validate(req.body);
  ...
  res.json({
    success: true,
    message: "Software Testing & QA saved successfully",
    data: result,
  });
});
...
exports.deleteService = asyncHandler(async (req, res) => {
  ...
  res.json({
    success: true,
    message: "Software Testing & QA deleted successfully",
  });
});
